...
export const LeftSideMenu = () => {
  ...
  return (
    <div className="w-full h-full absolute">
      ...
      {/* Sliding panel */}
      <div
        className={`fixed top-3 left-3 bottom-3 w-[300px] bg-[#0f0f0f] text-white shadow-2xl rounded-2xl border border-white/10 z-[90] transform transition-transform duration-300 ease-in-out ${showMenu ? 'translate-x-0' : '-translate-x-[calc(100%+1rem)]'
          }`}
      >
